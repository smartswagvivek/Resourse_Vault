...
//setVisible(true);
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(206, 233, 242));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 500, 430, 210));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/add (2).jpg"))); // NOI18N
  ...
  Statement st=null;
        ...
        con = java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306/dsatm", "root", "Bdvt@1234");
            ...
            pst = con.prepareStatement("Select * from loginpage where email=? and password=?");
